...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget groupTile(String userName,String groupId,String groupName,String admin){
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: ()async{
          await DatabaseService(uid:user!.uid).toggleGroup(groupId, userName, groupName);
          if(isJoined){
            setState(() {
              isJoined= !isJoined;
            });
        ...
        child: isJoined?Container(
          ...
          child: const Text('Joined',style: TextStyle(color: Colors.white,letterSpacing: 2),),
        ):Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(10),
          ...
          padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 10),
          child: const Text('Join Now',style: TextStyle(color: Colors.white,letterSpacing: 2),),
